                ...
                <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div class="flex items-center lg:order-2">                
                            <button data-collapse-toggle="mobile-menu-3" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-3" aria-expanded="false">
                        ...
                        <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-3">
                            ...
                            <>
                                <Link to="/dashboard/" className="block py-2 pr-4 pl-3 text-black rounded lg:bg-transparent lg:p-0 dark:text-white">Home</Link>
                                <Link to="/create-post/" className="block py-2 pr-4 pl-3 text-black rounded lg:bg-transparent lg:p-0 dark:text-white">Create a Post</Link>
                                <Link to="/your-posts/" className="block py-2 pr-4 pl-3 text-black rounded lg:bg-transparent lg:p-0 dark:text-white">Your Posts</Link>
                            </>
                            </ul>
                        </div>
                    </div>
